...
-- Dump completed on 2023-11-11 19:12:51
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'Joshua092003';
flush privileges;
use crypto;
select * from account;

insert into account (username, firstname, lastname, DOB, password)
	values ('joshua', 'josh', 'chen', '2003-12-12 12:00:00', '123');